...
<div class="container is-fluid mb-6">
    ...
    <h2 class="subtitle"><i class="fas fa-search-dollar fa-fw"></i> &nbsp;Buscar ventas por el código:</h2>
</div>
    ...
    <div class="columns">
        <div class="column">
            <form class="has-text-centered mt-6 mb-6 FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off" >
                ...
                <input type="hidden" name="modulo_url" value="<?php echo $url[0]; ?>">
                <p><i class="fas fa-search fa-fw"></i> &nbsp;Estás buscando por el código <strong>“<?php echo $_SESSION[$url[0]]; ?>”.</strong></p>
                <br>
