...
<div class="container pb-6 pt-6">
    ...
    <div class="columns">
        ...
        <div class="column pb-6">
            ...
            <p class="has-text-centered pt-6 pb-6">
                <small><b><i><u>Para agregar productos, debe escribir el código de barras en el campo "Código de producto" y luego presionar</u></i></b>&nbsp; <strong class="is-uppercase" ><i class="far fa-check-circle"></i> &nbsp;<b><i><u>Agregar producto</u></i></b></strong><b><i><u>. También puede agregar el producto mediante la opción</u></i></b>&nbsp; <strong class="is-uppercase"><i class="fas fa-search"></i> &nbsp;<b><i><u>Buscar producto</u></i></b></strong><b><i><u>. Además, puede escribir el código de barras y presionar la tecla</u></i></b><strong class="is-uppercase"><b><i><u> ENTER.</u></i></b></strong></small>
            </p>
            ...
            <div class="notification is-info is-light mb-2 mt-2">
                ...
                <p class="has-text-centered mb-2">La venta se realizó con éxito. ¿Que desea hacer?</p>
                <br>
                <div class="container">
                    <div class="columns">
        ...
        <div class="column is-one-quarter">
            <h3 class="title has-text-centered">DATOS DE LA VENTA</h3>
            <hr>
            ...
            <?php } ?>
                ...
                <div class="control mb-5">
                    <label>TOTAL A PAGAR POR EL CLIENTE<?php echo CAMPO_OBLIGATORIO; ?></label>
                    <input class="input" type="text" name="venta_abono" id="venta_abono" value="0.00" pattern="[0-9.]{1,25}" maxlength="25" >
                </div>

                <div class="control mb-5">
                    <label>CAMBIO DEVUELTO AL CLIENTE</label>
    ...
    <?php }else{ ?>
        <article class="message is-warning">
            ...
            <div class="message-body has-text-centered"><i class="fas fa-exclamation-triangle fa-2x"></i><br>No tenemos constancia de algunos datos sobre la empresa, por favor <a href="<?php echo APP_URL; ?>companyNew/" >verifique AQUÍ los datos de la empresa.</div>
        </article>
    <?php } ?>
</div>
...
<div class="modal" id="modal-js-client">
    ...
    <div class="modal-card">
        <header class="modal-card-head">
          <p class="modal-card-title is-uppercase"><i class="fas fa-search"></i> &nbsp;Buscar cliente:</p>
          <button class="delete" aria-label="close"></button>
        </header>
        <section class="modal-card-body">
            <div class="field mt-6 mb-6">
                <label class="label">DOCUMENTO, NOMBRE, APELLIDO O APELLIDOS, TELÉFONO</label>
                <div class="control">
    ...
    function buscar_cliente(){
        ...
        if(input_cliente!=""){
            ...
            Swal.fire({
                icon: 'error',
                title: 'HA OCURRIDO UN ERROR',
                text: 'Debes de introducir el NÚMERO de DOCUMENTO, NOMBRE, APELLIDO O APELLIDOS o TELÉFONO DEL CLIENTE.',
                confirmButtonText: 'Aceptar'
            });
        }
    }
