		...
		public function registrarCajaControlador(){
			...
			if($registrar_caja->rowCount()==1){
				$alerta=[
					...
					"texto"=>"La caja ".$nombre." #".$numero." se ha registrado con éxito.",
					"icono"=>"success"
				];
			}else{
				$alerta=[
					"tipo"=>"simple",
					"titulo"=>"HA OCURRIDO UN ERROR",
					"texto"=>"No se pudo registrar la caja, por favor inténtalo de nuevo.",
					"icono"=>"error"
				];
			}
		...
		public function eliminarCajaControlador(){
			...
			if($id==1){
				$alerta=[
					"tipo"=>"simple",
					"titulo"=>"HA OCURRIDO UN ERROR",
					"texto"=>"No podemos eliminar la caja.",
					"icono"=>"error"
				];
				return json_encode($alerta);
		        exit();
		    ...
		    if($eliminarCaja->rowCount()==1){
		    	...
		    	$alerta=[
					"tipo"=>"simple",
					"titulo"=>"HA OCURRIDO UN ERROR",
					"texto"=>"No hemos podido eliminar la caja ".$datos['caja_nombre']." #".$datos['caja_numero']." del sistema, por favor intñentelo de nuevo.",
					"icono"=>"error"
				];
		    }
		...
		public function actualizarCajaControlador(){
			...
			if($this->actualizarDatos("caja",$caja_datos_up,$condicion)){
				$alerta=[
					...
					"texto"=>"Los datos de la caja ".$datos['caja_nombre']." #".$datos['caja_numero']." se han actualizado correctamente.",
					"icono"=>"success"
				];
			}else{
				$alerta=[
					"tipo"=>"simple",
					"titulo"=>"HA OCURRIDO UN ERROR",
					"texto"=>"No hemos podido actualizar los datos de la caja ".$datos['caja_nombre']." #".$datos['caja_numero'].", por favor intémtelo de nuevo.",
					"icono"=>"error"
				];
			}
